...
for m in models:
    try:
        ...
        st.warning("Some historical days show 0\" snowfall using the ERA5-derived method. This occurs when ERA5 reports zero liquid precipitation at that grid point. If you have station observations (SnowStake / resort obs), we can integrate them for more accurate measured totals."), we can integrate them for more accurate measured totals.")
